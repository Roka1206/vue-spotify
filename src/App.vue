...
<template>
  <div>
      ...
      >
        <div class="flex items-center">
          <img
            class="rounded-full"
            width="27"
            src="https://avatars.githubusercontent.com/u/102240998?v=4"
          />
          <div class="text-white text-[14px] ml-1.5 font-semibold">Roka Dev</div>
    ...
    <div id="SideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
      <RouterLink to="/">
        <img width="125" src="/image/icons/spotify-logo.png" />
      </RouterLink>
      <div class="my-8"></div>
      <ul>
        <RouterLink to="/">
